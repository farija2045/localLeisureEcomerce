...
$this->title = 'Book Leisure Spot';
$this->params['breadcrumbs'][] = ['label' => 'Leisure Spots', 'url' => ['leisure/index']];
?>

<div class="book-view" style="min-height: 100vh;">
    <div class="booking-form-container booking-wb booking-wrapper">
